#!/bin/bash
#SBATCH --job-name=phi4_stage_2__clip_336__mlp
...
model_name="/leonardo_scratch/large/userexternal/dcaffagn/checkpoints/jeppetto/phi_st1__lr_1e_3__iwm_xe__clip_336__mlp/checkpoint-2180"
