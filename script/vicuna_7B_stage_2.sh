#!/bin/bash
#SBATCH --job-name=vicuna_7B_stage_2
...
model_name="/leonardo_scratch/large/userexternal/dcaffagn/checkpoints/jeppetto/vicuna_7B_stage_1__lr_1e_3/checkpoint-2181"
...
src/train/train.py \
--seed 42 \
--resume_from_checkpoint="/leonardo_scratch/large/userexternal/dcaffagn/checkpoints/jeppetto/vicuna_7B_stage_2/checkpoint-2000" \
